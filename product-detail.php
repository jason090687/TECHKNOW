					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="<?=substr($product_data['product_image'], 1);?>" alt="laptop" id="image" class="zoom" data-magnify-src="<?=substr($product_data['product_image'], 1);?>">
							</div>
								...
								<div class="col-md-10 col-md-offset-1">
									<div id="review-form">
										<form class="review-form" action="#" method="POST">
											<input class="input" type="text" placeholder="Your Name" name="customer_name"/>
											<input class="input" type="email" placeholder="Your Email" name="customer_email"/>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="product-detail.php?id=<?=$prods['product_id'];?>"><?=$prods['product_name'];?></a></h3>
