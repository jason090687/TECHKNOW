...
if (isset($_POST['submit'])) {
    ...
    if ($connect->query($order_insert_query) === TRUE) {
        ...
        $payment_insert_query = "INSERT INTO payments (order_id, payment_date, amount, payment_method) VALUES ('$order_id', '$order_date', '$subtotal', 'cod')";
        $connect->query($payment_insert_query);

        echo "We have successfully processed your order";
        $_SESSION['products'] = array();  // Clear the cart
    } else {
